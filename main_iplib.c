...
int main (int argc, char * argv[]) {
    ...
    else if (strcmp(operation, "gray_lum") == 0) {
        img = ip_mat_to_gray_scale_lum_corr(input_img);
    }
    else if (strcmp(operation, "gray_gamma") == 0) {
        img = ip_mat_to_gray_scale_gamma_corr(input_img);
    }
